...
See Section 4 for more information about what public key algorithms should be used and supported.
...
| Extension                    | OID         | Brief Description |
|:-----------------------------|:------------|:------------------|
...
| Name Constraints             | `2.5.29.30` | _Must not_ be used.
